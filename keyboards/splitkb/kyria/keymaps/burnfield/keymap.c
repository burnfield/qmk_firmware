...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWE] = LAYOUT(
    ...
    _______, SE_GUIA, SE_S,    SE_D,    SE_F,    SE_G,                      /**/                   SE_H,    SE_J,    SE_K,    SE_L,    HM_SCLN, _______,
    _______, SE_Z,    SE_ALTX, SE_SFTC, SE_CTLV, SE_B,    _______, _______, /**/ _______, _______, SE_N,    SE_CTLM, SE_SFTM, SE_ALTD, SE_SLSH, _______,
  		                       _______, _______, SE_SPC,  NAV,     _______, /**/ _______, SYM,     KC_BSPC, _______, _______),

  [_SYM] = LAYOUT(
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      /**/                   KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    _______,
    _______, HM_EXLM, SE_AT,   SE_HASH, SE_DLR,  SE_PERC,                   /**/                   MT_CIRC, SE_AMPR, SE_ASTR, SE_LPRN,  HM_RPRN, _______,
    _______, SE_GRV,  HM_BSLS, HM_PIPE, HM_QUOT, S(SE_2), _______, _______, /**/ _______, _______, SE_PLUS, HM_EQL,  HM_UNDS, HM_MINS,  MT_TILD, _______,
                               _______, _______, _______, _______, _______, /**/ _______, _______, _______, _______, _______),

  [_NAV] = LAYOUT(
  	_______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,                   /**/                   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
  	_______, LGUI_F5, KC_F6,   KC_F7,   KC_F8,   _______,                   /**/                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LGUI, _______,
  	_______, KC_F1,   LALT_F2, LSFT_F3, LCTL_F4, _______, _______, _______, /**/ _______, _______, CTL_LFT, KC_RCTL, KC_RSFT, CTL_RGT, KC_LALT, _______,

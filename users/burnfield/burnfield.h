...
#define _______________COLEMAK_R3_______________ KC_K, KC_H, KC_COMM, KC_DOT, KC_QUOT
...
#define _______________QWERTY_R3________________ KC_N, KC_M, KC_COMM, KC_DOT, KC_QUOT

#define _______________SYM_L1___________________ KC_ESC, KC_LBRC, KC_LCBR, KC_LPRN, KC_TILD
#define _______________SYM_L2___________________ KC_TAB, KC_ASTR, KC_EQL, KC_UNDS, KC_DLR
#define _______________SYM_L3___________________ KC_PLUS, KC_MINS, KC_AT, KC_SLSH, KC_PERC

#define _______________SYM_R1___________________ KC_CIRC, KC_RPRN, KC_RCBR, KC_RBRC, KC_GRV
#define _______________SYM_R2___________________ KC_HASH, OS_CTRL, OS_SHFT, OS_ALT, OS_GUI
#define _______________SYM_R3___________________ KC_PIPE, KC_BSLS, KC_AMPR, S(KC_SLSH), KC_EXLM
...
#define _______________NAV_L3___________________ DF(_QWE), _______, _______, RCTL(KC_Q), DF(_COLE)
...
#define _______________NUM_L2___________________ OS_GUI, OS_ALT, OS_SHFT, OS_CTRL, KC_F10
